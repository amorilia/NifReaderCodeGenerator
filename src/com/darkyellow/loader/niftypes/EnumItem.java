...
public class EnumItem
{
    ...
    private ArrayList<EnumItemOption> optionList = new ArrayList();
     ...
     */
    public ArrayList<EnumItemOption> getOptionList()
    {
        return optionList;
    }
     ...
     */
    public void setOptionList(ArrayList<EnumItemOption> optionList)
    {
    ...
    {
        EnumItemOption o = new EnumItemOption ();
        o.setName(name);
    ...
    public String toString()
    {
        ...
        while (i.hasNext())
        {
          EnumItemOption o = (EnumItemOption)i.next();
          s = s + "Option [" + j + "] [" + o + "]";
          j++;
        }
